-- Match-MA seller target parser prompt v0.4
-- Purpose: parse target subject, price/valuation time labels, and Chinese user-facing values.
...
values (
  ...
  'v0.4.0',
  'Seller target parser Chinese user-facing values',
  'Parse seller target descriptions into canonical seller_target fields with Chinese user-facing values.',
...
10. Omit fields when there is no evidence.',
  ...
  '{"source":"migration_022_seller_target_parser_prompt_v04"}'::jsonb
)
