-- Match-MA business update extractor prompt v0.4
-- Purpose: allow expanded buyer_intent_update fields in business updates.
...
values (
  ...
  'v0.4.0',
  'Business update extractor expanded buyer intent fields',
  'Extract pending-review actions with expanded buyer intent canonical fields.',
  ...
  "actions": [
    {
      ...
      "proposed_changes_json": {"major_risk_tolerance_summary": "..."},
...
10. If the input contains multiple independent matters, return multiple actions.',
  '{
    "type": "object",
    "required": ["actions"],
    "properties": {
  ...
  '{"source":"migration_016_business_update_extractor_prompt_v04"}'::jsonb
)
