-- Match-MA business update extractor prompt v0.5
-- Purpose: allow seller target subject and price date fields in business updates.
...
values (
  '00000000-0000-0000-0000-000000004219',
  '00000000-0000-0000-0000-000000000001',
  '00000000-0000-0000-0000-000000000101',
  'business_update_extractor',
  'v0.5.0',
  'Business update extractor seller target subject fields',
  'Extract pending-review actions with expanded seller target subject and price date canonical fields.',
...
11. If the input contains multiple independent matters, return multiple actions.',
  '{
    "type": "object",
    "required": ["actions"],
    "properties": {
  ...
  '{"source":"migration_019_business_update_extractor_prompt_v05"}'::jsonb
)
