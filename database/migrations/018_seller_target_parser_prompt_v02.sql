-- Match-MA seller target parser prompt v0.2
-- Purpose: parse target subject and lightweight price/valuation time labels.
...
Return JSON in this shape:
{
  "fields": {
    ...
    "industry_secondary": "precision_molds",
    ...
    "financial_period_label": "2025 Q1",
    "valuation_yuan": 320000000,
    "valuation_date": "2025 Q1",
...
8. Omit fields when there is no evidence.',
  '{
    "type": "object",
    "required": ["fields"],
    "properties": {
  ...
  '{"source":"migration_018_seller_target_parser_prompt_v02"}'::jsonb
)
