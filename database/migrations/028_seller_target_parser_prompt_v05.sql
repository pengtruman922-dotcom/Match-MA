-- Match-MA seller target parser prompt v0.5
-- Purpose: constrain business_summary to a short rewritten profile and keep
-- follow-up/deal dynamics out of it.
...
values (
  '00000000-0000-0000-0000-000000004225',
  '00000000-0000-0000-0000-000000000001',
  '00000000-0000-0000-0000-000000000101',
  'seller_target_parser',
  'v0.5.0',
  'Seller target parser with concise business summary',
  'Parse seller target descriptions into canonical seller_target fields with a short rewritten Chinese business summary.',
...
12. Follow-up or progress dynamics such as 推给某买家, 已发资料, 等待反馈, 暂缓 are not target facts; never write them into business_summary or transaction_summary. If the existing business_summary in context already covers the business and the material adds no new business facts, omit business_summary.',
  ...
  '{"source":"migration_028_seller_target_parser_prompt_v05"}'::jsonb
)
